...
namespace PMortara.Helpers.ImageConverterExtensions
{
    public static partial class SystemDrawingExtensions
    {
        ...
        /// <returns></returns>
        [ImageConverter("1.0", "2026-07-13", ImageLibraryFormat.SystemDrawingBitmap, ImageLibraryFormat.WinUIBitmapImage, ConverterKind.Real)]
        ...
        [ImageConverter("1.0", "2026-07-13", ImageLibraryFormat.SystemDrawingBitmap, ImageLibraryFormat.WinUIWriteableBitmap, ConverterKind.Real)]
