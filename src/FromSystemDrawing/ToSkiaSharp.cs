...
namespace PMortara.Helpers.ImageConverterExtensions
{
    public static partial class SystemDrawingExtensions
    {
        ...
        /// <returns></returns>
        [ImageConverter("1.0", "2024-11-04", ImageLibraryFormat.SystemDrawingIcon, ImageLibraryFormat.SKBitmap, ConverterKind.Real)]
        ...
        /// <param name="icon"></param>
        /// <returns></returns>
        [ImageConverter("1.0", "2024-11-04", ImageLibraryFormat.SystemDrawingIcon, ImageLibraryFormat.SKImage, ConverterKind.Real)]
