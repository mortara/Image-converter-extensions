...
namespace PMortara.Helpers.ImageConverterExtensions
{
    public static partial class SKBitmapExtensions
    {
        ...
        /// </ToDo>
        [ImageConverter("1.0", "2024-11-05", ImageLibraryFormat.SKBitmap, ImageLibraryFormat.EMGUCVImage, ConverterKind.Real,
        ...
        /// </ToDo>
        [ImageConverter("1.0", "2024-11-10", ImageLibraryFormat.SKBitmap, ImageLibraryFormat.EMGUCVImage, ConverterKind.InMemoryWrapper)]
